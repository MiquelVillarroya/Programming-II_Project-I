...
Object::Object(const Point& p, ObjectType t) : Entity(p, OBJECT_PHYSICAL_SIZE, OBJECT_PHYSICAL_SIZE, OBJECT_FRAME_SIZE, OBJECT_FRAME_SIZE)
{
	...
	switch (type)
	{
		...
		case ObjectType::KEY_RED: rc = {6*n, 3*n, n, n}; break;
		case ObjectType::KEY_YELLOW: rc = {7*n, 3*n, n, n}; break;
...
int Object::Points() const
{
	...
	else if (type == ObjectType::KEY_RED)	return POINTS_KEY_RED;
	else if (type == ObjectType::KEY_YELLOW)	return POINTS_KEY_YELLOW;
